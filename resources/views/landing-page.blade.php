...
<section id="hero" class="hero-bg min-h-screen flex items-center relative overflow-hidden pt-24 pb-16">
    ...
    <div class="container mx-auto px-6 grid lg:grid-cols-2 items-center gap-16 relative z-10">
        <div>
            ...
            <h1 class="text-5xl lg:text-7xl font-black leading-tight mb-6 reveal" style="transition-delay:0.1s">
                Genteng Kuat,<br>Rumah <span class="text-gradient">Aman</span> &amp;<br><span class="text-gradient">Indah</span>
            </h1>
            <p class="text-gray-400 text-lg leading-relaxed max-w-lg mb-10 reveal" style="transition-delay:0.2s">
                Genteng pilihan kualitas premium — tahan cuaca ekstrem, desain modern, dan harga bersaing. Dipercaya ribuan keluarga di seluruh Indonesia.
            </p>
...
<section id="keunggulan" class="py-28 bg-[#0f0f0f] relative overflow-hidden">
    ...
    <div class="container mx-auto px-6">
        ...
        <div class="grid md:grid-cols-3 gap-8">
            ...
            <div class="rounded-3xl p-8 card-hover reveal relative overflow-hidden" style="transition-delay:0.2s; background: linear-gradient(135deg, #9f1239, #e11d48, #f97316);">
                ...
                <div class="mt-6 flex items-center gap-2 text-white text-sm font-semibold">
                    <span>Pelajari lebih lanjut</span>
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/></svg>
                </div>
            </div>
    ...
    <div class="container mx-auto px-6">
        <div class="flex flex-col md:flex-row md:items-end md:justify-between mb-16 reveal gap-4">
            <div>
                ...
                <h2 class="text-4xl lg:text-5xl font-black mt-3">Produk <span class="text-gradient">Genteng</span></h2>
            </div>
...
<section id="lokasi" class="py-28 bg-[#0a0a0a]">
    <div class="container mx-auto px-6">
        <div class="text-center mb-14 reveal">
            ...
            <p class="text-gray-500 mt-4 text-sm">Kunjungi showroom kami untuk pengalaman langsung melihat produk unggulan kami.</p>
        </div>
